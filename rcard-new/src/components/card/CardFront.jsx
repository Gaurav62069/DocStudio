...
const CardFront = ({ details }) => {
  ...
  return (
    ...
    >
      {/* LEFT SIDE */}
      <div className="w-1/2 border border-black px-3 pt-2 relative mr-2">
        <h5 className="text-center font-bold text-[15px] leading-4 mb-2">
          अपवर्जन/समावेशन मानक के आलोक में
          <br />
          परिवारिक सुचि
        </h5>

        <p className="border border-black text-center text-[11px] font-bold py-[2px]  mb-2">
        ...
        <table className="w-full border-collapse text-[11px]">
          ...
          <tbody>
            ...
            <tr>
              <td
                colSpan="5"
                className="border border-black font-bold text-left pl-1"
              >
        ...
        {/* Footer */}
        <div className="absolute bottom-4 left-0 right-0 bottom-15 text-center">
          <p className="font-bold text-[12px]">Help Line No :- 18003456598</p>
      ...
      {/* RIGHT SIDE */}
      <div className="w-1/2 px-3 pt-5 relative flex flex-col items-center border border-black ml-2">
        ...
        <h5 className="font-bold text-center text-[14px] leading-5">
        ...
        <div className="absolute bottom-26 left-2 right-2">
          <p className="border border-black text-center text-[11px] font-bold py-[2px]">
            Ration Card No. / राशन कार्ड संख्या :{" "}
            {details.rcNumber || "XXXXXXXX"}
          </p>

          <p className="text-center font-bold text-[13px] mt-2">
